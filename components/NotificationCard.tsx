    ...
    <div className='flex items-center justify-center w-full h-full px-4 py-12'>
      <div className='max-w-xs px-4 py-6 bg-white rounded shadow sm:max-w-sm sm:px-8'>
        <div className='flex items-center justify-between'>
          <div>
            <p className='text-4xl font-medium leading-9 text-gray-800 '>16</p>
            <p className='mt-1 text-xs font-medium leading-3 text-gray-500 '>
              Unread
            </p>
          </div>
        ...
        <div className='pb-3 mt-6 border-b border-gray-200'>
          ...
          <div className='flex items-center justify-between mt-2'>
            ...
            <p className='text-xs font-medium leading-3 text-right text-gray-500 '>
              3 hrs ago
            </p>
          </div>
        </div>
        ...
        <p className='mt-4 text-xs font-medium leading-none text-indigo-700'>
          +12 more
        </p>
      </div>
    </div>
